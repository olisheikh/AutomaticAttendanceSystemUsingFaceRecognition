                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                self.t=datetime.datetime.now().strftime("%H:%M")
                                self.engine.say(name)
                                self.engine.say('Clocked in at')
                                self.engine.say(self.t)
                                #end speech

                                date_time_string = datetime.datetime.now().strftime("%y/%m/%d %H:%M:%S")
                                f.writelines(f'\n{name},{self.depts},{date_time_string},Clock In')
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                self.t = datetime.datetime.now().strftime("%H:%M")
                                self.engine.say(name)
                                self.engine.say('Clocked Out At')
                                self.engine.say(self.t )


                                date_time_string = datetime.datetime.now().strftime("%y/%m/%d %H:%M:%S")
                                f.writelines(f'\n{name},{self.depts},{date_time_string},Clock Out')
